...
function overrideBarcodeScanner() {
    ...
    erpnext.utils.BarcodeScanner = class CustomBarcodeScanner {
        constructor(opts) {
            ...
            this.scan_api = opts.scan_api || "surgishoperpnext.surgishoperpnext.api.barcode.scan_barcode";
            ...
            return new Promise((resolve, reject) => {
                ...
                this.scan_api_call(input, (r) => {
                    ...
                    if (!data || Object.keys(data).length === 0) {
                        this.show_alert("Cannot find Item with this Barcode", "red");
                        this.clean_up();
            ...
            return new Promise((resolve, reject) => {
                ...
                if (!row) {
                    if (this.dont_allow_new_row) {
                        this.show_alert(`Maximum quantity scanned for item ${item_code}.`, "red");
                        this.clean_up();
                        reject();
                        return;
                    }
        ...
        set_item(row, item_code, barcode, batch_no, serial_no) {
            return new Promise((resolve) => {
                ...
                if (this.prompt_qty) {
                    frappe.prompt(`Please enter quantity for item ${item_code}`, ({ value }) => {
