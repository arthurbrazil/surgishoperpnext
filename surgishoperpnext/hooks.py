...
app_include_js = [
	"/assets/surgishoperpnext/js/gs1-utils.js?v=0.1.32",
	"/assets/surgishoperpnext/js/custom-barcode-scanner.js?v=0.1.32",
	"/assets/surgishoperpnext/js/custom-serial-batch-selector.js?v=0.1.32"
]
